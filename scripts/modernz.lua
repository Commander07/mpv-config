...
local user_opts = {
    ...
    hover_button_size = 34,                -- the size of a hovered button if the size effect is selected
...
local function set_osc_styles()
    osc_styles = {
        ...
        elementHover = "{" .. (user_opts.hovereffect == "glow" and "\\blur5" or "") .. "\\2c&HFFFFFF&" .. (user_opts.hovereffect == "size" and "\\fs"..user_opts.hover_button_size or "") .. "}",
